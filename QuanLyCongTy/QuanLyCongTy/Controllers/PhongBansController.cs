...
namespace QuanLyCongTy.Controllers
{
    public class PhongBansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDPhongBan,NamePhongBan")] PhongBan phongBan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDPhongBan,NamePhongBan")] PhongBan phongBan)
        {
            if (ModelState.IsValid)
            {
